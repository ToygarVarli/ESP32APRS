...
// ESP32 ve AVR uyumlu makrolar
    ...
    // ESP32 için interrupt disable/enable
    static portMUX_TYPE ax25Mux = portMUX_INITIALIZER_UNLOCKED;
    #define cli() portENTER_CRITICAL(&ax25Mux)
    #define sei() portEXIT_CRITICAL(&ax25Mux)
#else
    // AVR için cli/sei zaten tanımlı (avr/interrupt.h)
